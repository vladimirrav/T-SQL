...
select	@preco_g = 5.738,
		@valor = 112.86,
		@litros = 50; --50; /* Se o valor for informado este é utilizado no cálculo ao invés de @valor */
...
(	'Cálulo da autonomia com gasolina', char(10), char(9),
	'Preço/L: R$ ', @preco_g, char(10), char(9),
	'Preço/Km: R$ ', @valor_km_g, char(10), char(9),
...
select	@preco_e = 3.270,
		@valor = 50.0,
		@litros = 50; /* Se o valor for informado este é utilizado no cálculo ao invés de @valor */
...
(	'Cálulo da autonomia com etanol', char(10), char(9),
	'Preço/L: R$ ', @preco_e, char(10), char(9),
	'Preço/Km: R$ ', @valor_km_e, char(10), char(9),
	'Valor: R$ ', @valor, char(10), char(9),
	'Litros: ', @litros, char(10), char(9),
